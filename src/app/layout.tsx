        ...
        >
          <div className="flex h-screen overflow-hidden bg-background">
            ...
            <aside className="w-64 bg-sidebar text-sidebar-foreground flex-col hidden md:flex border-r border-sidebar-border/10 shrink-0">
              ...
              <div className="p-4 border-t border-sidebar-border/10 flex items-center justify-between">
                <div className="flex items-center space-x-3">
                  <div className="w-10 h-10 rounded-full bg-primary flex items-center justify-center text-primary-foreground font-bold">OA</div>
                  <div>
            ...
            <div className="flex-1 flex flex-col min-w-0 overflow-hidden">
              {/* Mobile top bar + drawer (client component) */}
              <MobileNav />
